...
// component copy from https://www.landingfolio.com/library/footer/react?id=616d108199d49f4ae8c35e80
...
const ComponentName = () => {        
    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        ...
        <p className="text-sm text-center text-gray-600">© Copyright 2021, All Rights Reserved by Ayush </p>
    </div>
</section>

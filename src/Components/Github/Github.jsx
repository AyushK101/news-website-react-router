...
function Github() {
  ...
  return (
    ...
    <div className='text-center font-mono font-bold text-4xl bg-slate-700 text-white pl-[40%] m-3 '><a target='_blank' href="https://github.com/AyushK101"><img src={data?.data?.avatar_url} /></a> </div>
